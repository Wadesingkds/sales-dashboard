          ...
          <div style={{ background: '#fff', borderRadius: 12, maxWidth: 500, width: '100%', maxHeight: '90vh', overflow: 'auto', boxShadow: '0 20px 40px rgba(0,0,0,0.15)' }} onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmitForm} style={{ padding: 24 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div><label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: TEXT, marginBottom: 6 }}>Nama Debitur *</label><input type="text" required value={formData.namaDebitur} onChange={e => setFormData(prev => ({ ...prev, namaDebitur: e.target.value }))} style={{ width: '100%', height: 38, padding: '0 12px', fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: '#fff', color: TEXT }} /></div>
                <div><label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: TEXT, marginBottom: 6 }}>Bulan</label><input type="text" value={formData.bulan} onChange={e => setFormData(prev => ({ ...prev, bulan: e.target.value }))} style={{ width: '100%', height: 38, padding: '0 12px', fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: '#fff', color: TEXT }} /></div>
                <div><label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: TEXT, marginBottom: 6 }}>Pemberi Reff</label><input type="text" value={formData.pemberiReff} onChange={e => setFormData(prev => ({ ...prev, pemberiReff: e.target.value }))} style={{ width: '100%', height: 38, padding: '0 12px', fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: '#fff', color: TEXT }} /></div>
                <div><label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: TEXT, marginBottom: 6 }}>Produk</label><input type="text" value={formData.produk} onChange={e => setFormData(prev => ({ ...prev, produk: e.target.value }))} style={{ width: '100%', height: 38, padding: '0 12px', fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: '#fff', color: TEXT }} /></div>
                <div><label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: TEXT, marginBottom: 6 }}>Analisis</label><input type="text" value={formData.analisis} onChange={e => setFormData(prev => ({ ...prev, analisis: e.target.value }))} style={{ width: '100%', height: 38, padding: '0 12px', fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: '#fff', color: TEXT }} /></div>
                <div><label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: TEXT, marginBottom: 6 }}>Potensi Pembiayaan</label><input type="number" value={formData.potensiPembiayaan} onChange={e => setFormData(prev => ({ ...prev, potensiPembiayaan: e.target.value }))} style={{ width: '100%', height: 38, padding: '0 12px', fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: '#fff', color: TEXT }} /></div>
                <div><label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: TEXT, marginBottom: 6 }}>Status</label><input type="text" value={formData.status} onChange={e => setFormData(prev => ({ ...prev, status: e.target.value }))} style={{ width: '100%', height: 38, padding: '0 12px', fontSize: 13, border: `1px solid ${BORDER}`, borderRadius: 6, background: '#fff', color: TEXT }} /></div>
